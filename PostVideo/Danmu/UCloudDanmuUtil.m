...
@implementation UCloudDanmuUtil
...
{
    return @{@"c": [NSNumber numberWithLong:[UCloudDanmuUtil argbFromHex: @"#ffffff"]],
             @"m": @"l",
             @"p": @"t",
             @"s": @"m",
             @"l": @"n"
...
+ (NSDictionary *)randomOptions
{
    ...
    return @{@"c": [NSNumber numberWithLong:[UCloudDanmuUtil argbFromHex:arColor[c]]],
             @"m": arMode[m],
             @"p": @"t",
             @"s": arFontSize[s],
             @"l": @"n"
